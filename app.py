...
## Streamlit App
st.set_page_config(page_title="Resume Reviewer",page_icon=":heavy_dollar_sign:")
...
st.subheader('Enhance Your Resume with AI Insights, ensuring it surpasses ATS screening in the your job search.')
...
You are an skilled ATS (Applicant Tracking System) scanner with a deep understanding of Software Development,
Data Science, Full Stack Web Development, DEVOPS, Data Analyst, Data Engineering and deep ATS functionality. 
Your task is to find any spelling errors, typos, grammatical errors and formatting issues miskates in the resume. 
Also, Give me some highlights about the sentence structure used in the resume and if it requires any changes. 
First the output should come about spelling and gramatical errors and then scope of improviment in the sentences used in resume and last final thoughts. Don't 
give grammatical in the given prompts, use only resume.
"""
...
best practices. Provide feedback on optimizing your resume to enhance its compatibility with Applicant Tracking 
Systems.
"""
...
You are an skilled ATS (Applicant Tracking System) scanner with a deep understanding of Software Development,
Data Science, Full Stack Web Development, DEVOPS, Data Analyst, Data Engineering and deep ATS functionality. 
Your task is to determine that did the given resume effectively showcase his/her accomplishments and quantify 
their impact? Were the achievements specific, measurable, achievable, relevant, and time-bound (SMART)? Give
detailed feedback(in points) on areas for improvement for future job searches. Candidates appreciate constructive 
criticism and the opportunity to learn from the experience.
"""
